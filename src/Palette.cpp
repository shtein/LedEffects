...
const TProgmemRGBPalette16 IsraelFlag_p FL_PROGMEM ={
  ISRL_FLAG_WHITE, ISRL_FLAG_WHITE, ISRL_FLAG_WHITE, ISRL_FLAG_WHITE,
  ISRL_FLAG_WHITE, ISRL_FLAG_WHITE, ISRL_FLAG_WHITE, ISRL_FLAG_WHITE,
  ISRL_FLAG_WHITE, ISRL_FLAG_BLUE, ISRL_FLAG_BLUE, ISRL_FLAG_BLUE,
  ISRL_FLAG_BLUE, ISRL_FLAG_BLUE, ISRL_FLAG_BLUE, ISRL_FLAG_BLUE
};
